...
/**
 */
@io.quarkus.Generated(value = "by gRPC proto compiler (version 1.59.0)", comments = "Source: hello.proto")
...
public final class HelloGrpcGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.example.HelloRequest, com.example.HelloReply> getSayHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "SayHello", requestType = com.example.HelloRequest.class, responseType = com.example.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.example.HelloRequest, com.example.HelloReply> getSayHelloMethod() {
        ...
        if ((getSayHelloMethod = HelloGrpcGrpc.getSayHelloMethod) == null) {
            synchronized (HelloGrpcGrpc.class) {
                if ((getSayHelloMethod = HelloGrpcGrpc.getSayHelloMethod) == null) {
                    HelloGrpcGrpc.getSayHelloMethod = getSayHelloMethod = io.grpc.MethodDescriptor.<com.example.HelloRequest, com.example.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.UNARY).setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.example.HelloRequest.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.example.HelloReply.getDefaultInstance())).setSchemaDescriptor(new HelloGrpcMethodDescriptorSupplier("SayHello")).build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        /**
         */
        default void sayHello(com.example.HelloRequest request, io.grpc.stub.StreamObserver<com.example.HelloReply> responseObserver) {
    ...
    public static class HelloGrpcStub extends io.grpc.stub.AbstractAsyncStub<HelloGrpcStub> {
        ...
        /**
         */
        public void sayHello(com.example.HelloRequest request, io.grpc.stub.StreamObserver<com.example.HelloReply> responseObserver) {
    ...
    public static class HelloGrpcFutureStub extends io.grpc.stub.AbstractFutureStub<HelloGrpcFutureStub> {
        ...
        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<com.example.HelloReply> sayHello(com.example.HelloRequest request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    serviceImpl.sayHello((com.example.HelloRequest) request, (io.grpc.stub.StreamObserver<com.example.HelloReply>) responseObserver);
                    break;
                default:
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<com.example.HelloRequest, com.example.HelloReply>(service, METHODID_SAY_HELLO))).build();
    }
    ...
    private static abstract class HelloGrpcBaseDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.example.HelloGrpcProto.getDescriptor();
        }
