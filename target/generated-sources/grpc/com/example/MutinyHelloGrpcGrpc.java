...
import static com.example.HelloGrpcGrpc.getServiceDescriptor;
...
public final class MutinyHelloGrpcGrpc implements io.quarkus.grpc.MutinyGrpc {
    ...
    public static class MutinyHelloGrpcStub extends io.grpc.stub.AbstractStub<MutinyHelloGrpcStub> implements io.quarkus.grpc.MutinyStub {
        ...
        public io.smallrye.mutiny.Uni<com.example.HelloReply> sayHello(com.example.HelloRequest request) {
    ...
    public static abstract class HelloGrpcImplBase implements io.grpc.BindableService {
        ...
        public io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(com.example.HelloGrpcGrpc.getSayHelloMethod(), asyncUnaryCall(new MethodHandlers<com.example.HelloRequest, com.example.HelloReply>(this, METHODID_SAY_HELLO, compression))).build();
        }
    }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    io.quarkus.grpc.stubs.ServerCalls.oneToOne((com.example.HelloRequest) request, (io.grpc.stub.StreamObserver<com.example.HelloReply>) responseObserver, compression, serviceImpl::sayHello);
                    break;
                default:
